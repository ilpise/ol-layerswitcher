                ...
                if (lyr.get('type') === 'base') {
                    ...
                    if (options.legendInLine == "1") {
                        ...
                        var icon = document.createElement('span');
												...
												console.log("IN LINE LYR getSource().getURL()");
                        ...
                        **/
                        ...
                        _btn2.className = 'btn btn-default btn-sm legend';
                        // var icon = document.createElement('span');
												//
                        // // Set glyphicon icon
                        ...
                        li.appendChild(_btn2);
												...
												// var icon = document.createElement('i')
												// icon.setAttribute("data-bs-target", "#tg" + checkboxId);
                        ...
                        // li.appendChild(icon);
												...
												console.log("NOT IN LINE LYR getSource().getURL()");
												console.log(lyr.getSource().getUrl());
                        ...
                        _legend.src = graphicUrl + '&LAYERTITLE=false&RULELABEL=false&LAYER=' + lyr.get('title');
												...
												var col_op = document.createElement('div')
